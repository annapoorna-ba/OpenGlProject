...
{    glColor3f(0.000, 0.749, 1.000); 
	print(33, 500, " SAI VIDYA INSTITUTE OF TECHNOLOGY ",GLUT_BITMAP_TIMES_ROMAN_24);      
	...
	print(40, 470, " Rajanukunte, Bengaluru- 560 064 ",GLUT_BITMAP_HELVETICA_18);  

	print(30, 400, " DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING ",GLUT_BITMAP_HELVETICA_18); 
	 glColor3f(1,1,1);  
	print(40, 300, " SORTING VISUALIZER ",GLUT_BITMAP_TIMES_ROMAN_24);
	 glColor3f(0.000, 0.749, 1.000); 
	 glColor3f(0,  1, 0);
	print(70, 175, " By: ",GLUT_BITMAP_HELVETICA_18); 
	print(70, 150, " Bhavana G 		 - 1VA17CS012 ",GLUT_BITMAP_HELVETICA_18);  
	print(70, 120, " Annapoorna B A    - 1VA17CS005 ",GLUT_BITMAP_HELVETICA_18);  
	print(70, 90,  " Prajwal Srinivas  - 1VA17CS034 ",GLUT_BITMAP_HELVETICA_18);  
